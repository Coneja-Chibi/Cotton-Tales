...
export function openSummaryVectorEditor(emotionName = null) {
    ...
    const modalHtml = `
        <div id="ct-summary-vector-modal" style="position: fixed; top: 0; left: 0; right: 0; bottom: 0; background: rgba(0,0,0,0.7); z-index: 10100; display: flex; align-items: center; justify-content: center;">
...
export function openKeywordBoostEditor(keyword = null) {
    ...
    const modalHtml = `
        <div id="ct-keyword-boost-modal" style="position: fixed; top: 0; left: 0; right: 0; bottom: 0; background: rgba(0,0,0,0.7); z-index: 10100; display: flex; align-items: center; justify-content: center;">
